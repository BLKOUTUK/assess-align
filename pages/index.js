...
from-purple-800
to-indigo-900
mix-blend-multiply\ aria-hidden=\true\></div>
          </div>
          <div className=\relative
max-w-7xl
mx-auto
...
sm:px-6
lg:px-8\>
            <h1 className=\text-4xl
font-extrabold
tracking-tight
text-white
sm:text-5xl
lg:text-6xl\>Assess & Align</h1>
            <p className=\mt-6
text-xl
text-indigo-100
max-w-3xl\>
...
lg:px-8\>
            <div className=\lg:text-center\>
              <h2 className=\text-base
text-indigo-600
font-semibold
tracking-wide
uppercase\>Features</h2>
              <p className=\mt-2
text-3xl
leading-8
font-extrabold
...
text-white\>
                    <svg className=\h-6
w-6\ xmlns=\http://www.w3.org/2000/svg\ fill=\none\ viewBox=\0
0
24
...
leading-6
font-medium
text-gray-900\>Research Request Analysis</h3>
                    <p className=\mt-2
text-base
text-gray-500\>
...
leading-6
font-medium
text-gray-900\>Equity Assessment</h3>
                    <p className=\mt-2
text-base
text-gray-500\>
...
leading-6
font-medium
text-gray-900\>AI-Generated Feedback</h3>
                    <p className=\mt-2
text-base
text-gray-500\>
...
leading-6
font-medium
text-gray-900\>Impact Analytics</h3>
                    <p className=\mt-2
text-base
text-gray-500\>
